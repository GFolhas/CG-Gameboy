...
GLfloat  jadeDif []={   0.54 ,0.89 ,0.63, alpha};
...
GLfloat  copperAmb []={ 0.2 ,0.3 ,0.4 };
GLfloat  copperDif []={   0.2 ,0.3 ,0.4 };
...
GLfloat whitePlasticAmb []={ 0.2 ,0.1 ,0.4 };
GLfloat whitePlasticDif []={   0.2 ,0.1 ,0.4 };
